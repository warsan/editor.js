...
1. [Загрузить ядро редактора](#загрузить-ядро-редактора)
2. [Загрузить инструменты](#загрузите-инструменты)
3. [Инициализировать экземпляр редактора](#создайте-экземпляр-редактора)
